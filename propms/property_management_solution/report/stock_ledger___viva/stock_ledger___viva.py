...
def execute(filters=None):
	...
	for sle in sl_entries:
		...
		if sle.voucher_type == "Sales Invoice":
			sle["cost_center"] = frappe.db.get_value("Sales Invoice Item", {"parent": sle.voucher_no, "item_code": sle.item_code}, "cost_center")
			
		data.append(sle)

		# If document is Sales Invoice, get the cost center from Sales Invoice
